...
for istep = 1:Nstep
    ...
    % Rs
    [Rs_det1, Rs_det2, D_det1, D_det2] = numexperiment2_rdet(r1{1}, r2{1}, rdet, normV_det, obj1);
    Rs_rrn = numexperiment2_rrn(r1, sinp1, Jstr1, obj1);
    Rs_r12 = numexperiment2_r12(r1, r2, sinp2, Jstr2, obj1);
    Rs_rof = numexperiment2_rof(r2, focalposition, w_cone, obj1);
...
% model function(s)
% fun1
function [Rs_det1, Rs_det2, D_det1, D_det2] = numexperiment2_rdet(r1, r2, rdet, normV, object)
% r_d^*n^/r_d^2
...
[D_det2, L2] = intersectionABO(rdet, r2, object, 'net');

r10 = normr(repelem(rdet, n1, 1) - repmat(r1, n0, 1));
r20 = normr(repelem(rdet, n2, 1) - repmat(r2, n0, 1));
Rs_det1 = sum(r10.*repelem(normV, n1, 1), 2)./L1.^2./(pi*4);
Rs_det2 = sum(r20.*repelem(normV, n2, 1), 2)./L2.^2./(pi*4);
...
%     Rs_rrn{isct} = Rs_rrn{isct-1}./sum(r12.^2, 2).*sinp{isct-2}.*J{isct-2}./(pi*4);
    [D_rrn{isct}, L] = intersectionABO(r1{isct-2}, r1{isct-1}, object, 'lines');
...
% fun3
function [Rs_r12, D_r12] = numexperiment2_r12(r1, r2, sinp, J, object)
% 1/r12^2, single view
...
% fun4
function [Rs_rof, D_rof] = numexperiment2_rof(r2, focalpos, w, object)
% 1/r_f^2, single view
