...
load('E:\matlab\Data\offfocaltest.mat');
...
% offstartview = 1 - ceil(max(phi_off)/delta_view);
...
% off-focal kernel
offkernel = offfocalhernal(offintensity, offwidth, offedge, SID, offsample, t_off);
...
function offkernel = offfocalhernal(offintensity, offwidth, offedge, SID, offsample, t_off)
