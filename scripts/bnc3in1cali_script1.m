...
% rawdata_file.head = {[], [], [], []};
rawdata_file.empty = {[], ...
                      'F:\data-Dier.Z\PG\air\Air_100KV250mA_empty_small\2.1581842873375.pd', ...
                      'F:\data-Dier.Z\PG\air\Air_120KV250mA_empty_small\2.1581842873373.pd', ...
                      'F:\data-Dier.Z\PG\air\Air_140KV250mA_empty_small\2.1581842873371.pd'};
rawdata_file.body = {[], ...
                     'F:\data-Dier.Z\PG\air\Air_100KV250mA_body_small\2.1581843116413.pd', ...
                     'F:\data-Dier.Z\PG\air\Air_120KV250mA_body_small\2.1581843115411.pd', ...
                     'F:\data-Dier.Z\PG\air\Air_140KV250mA_body_small\2.1581843114409.pd'};
rawdata_file.head = {[], ...
                     'F:\data-Dier.Z\PG\air\Air_100KV250mA_head_small\2.1581843427477.pd', ...
                     'F:\data-Dier.Z\PG\air\Air_120KV250mA_head_small\2.1581843425475.pd', ...
                     'F:\data-Dier.Z\PG\air\Air_140KV250mA_head_small\2.1581843423473.pd'};
...
% scan data method (how to get the rawdata, prepared, do real scan or do simulation)
scan_data_method = 'prep';      % 'prep', 'real' or 'simu'.

% only for 'simu', to replace the response_file
% response_file = 'E:\matlab\CT\SINO\TM\detector\response_1219.mat';
% NOTE: In any the scan method the response_file shall be defined in system_cfgfile. But when do 'simu' the response in 
%   simulation and calibration can be different. If they are same the calibration could be too 'easy' to present a real
%   calibration progress by simulation. Because in real progress we can not pre-prepare the exact response, in simulation we
%   employ a 'wrong' response curve for calibration on purpose to simulate that condition.
...
switch scan_data_method
    case 'simu'
        ...
        % replace the response (only for simulation)
