...
if isfield(system_cfg, 'collimation')
    ...
    if isfield(system_cfg.collimation, 'bowtie')
        ...
        % copy
        system.collimation.bowtie.bowtie_corr = system_cfg.collimation.bowtie;
        % bowtie curve
        bowtie_corr = loaddata(system_cfg.collimation.bowtie.bowtiedata);
        system.collimation.bowtie.bowtie_corr = ...
            structmerge(system.collimation.bowtie.bowtie_corr, bowtie_corr, true);
    end
    % filter
