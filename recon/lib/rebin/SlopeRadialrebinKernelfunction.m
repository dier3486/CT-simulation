function [dataflow, prmflow, status] = SlopeRadialrebinKernelfunction(dataflow, prmflow, status)
% recon node, Axial slope-radial rebin kernel function
% [dataflow, prmflow, status] = SlopeRadialrebinKernelfunction(dataflow, prmflow, status);
% Support (X)DFS
