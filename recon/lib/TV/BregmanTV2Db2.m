function u = BregmanTV2Db2(img0, mu, lambda, u0, Crange, Niter, tol, balance)
...
du(end,:,:, 1) = du(end,:,:, 1) - du(end-2,:,:, 1) - du(end-3,:,:, 1);
du(:,end,:, 2) = du(:,end,:, 2) - du(:,end-2,:, 2) - du(:,end-3,:, 2);
